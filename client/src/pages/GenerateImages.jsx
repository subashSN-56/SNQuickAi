...
>
  {item}
            ...
            <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#7b2eb2] to-[#d96217] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
